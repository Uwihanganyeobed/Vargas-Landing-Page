  ...
  return (
    <div className="flex flex-row md:flex-col gap: 1">
      <div className="flex-1 p-4">
        ...
        <p className='mb-8'>Thanks for supporting the Obed channel!</p>
        <p className='mb-8'>I have coding projects because I believe it can completely transform a company's life and help them become financially secure.</p>
        <p className='mb-8'>Your donation will help cover the costs of running the website and will help purchase necessary equipment and software for making videos.</p>
        <p className="text-gray-500 mb-8">(Note: Vargas tech is not an officially registered charity so a tax slip currently cannot be provided for your donation)</p>
      ...
      <div className="flex-1 p-4">
        <img src={assets.user} alt="Support Image" className="w-100"/>
      </div>
    </div>
  );
};
